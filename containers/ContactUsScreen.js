    ...
    return (
        <ScrollView style={{ flex: 1, padding: 1 }}>
            <View style={{ padding: 10, alignItems: 'center' }}>
                ...
                <View style={{ margin: 5, backgroundColor: '#f5c542', alignItems: 'center', paddingBottom: 10, width: "100%",borderRadius:10 }}>
                    <Text style={{ fontSize: 22, padding: 10, fontWeight:'bold'}}>
                        Office Address
                    </Text>
                    <View style={{ backgroundColor: "yellow", padding: 10, margin: 10, width: '90%', borderRadius: 10 ,elevation:20,}}>
                ...
                <View style={{ margin: 5, backgroundColor: '#f5c542', alignItems: 'center', paddingBottom: 10, paddingTop: 10, width: "100%" }}>
                    <Text style={{ fontSize: 22, padding: 10, fontWeight:'bold'}}>
                        Email Address
                    </Text>
                    <View style={{ backgroundColor: "yellow", padding: 10, margin: 10, width: '90%', borderRadius: 10,elevation:20, }}>
                ...
                {/* <Text style={{ fontSize: 28,padding:10 }}>{"<"}-Get in touch with us-{">"}</Text> */}
                <View style={{ margin: 5, backgroundColor: '#f5c542', alignItems: 'center', paddingBottom: 10, width: "100%" }}>
                    <Text style={{ fontSize: 22, padding: 10, fontWeight:'bold'}}>
                        Call/Whatsapp
                    </Text>
                    <View style={{ backgroundColor: "yellow", padding: 10, margin: 10, width: '90%', borderRadius: 10,elevation:20, }}>
                        <Text style={{ fontSize: 22, margin: 10, }}>(+91) 9082-555-082
(+91) 9960-147-139</Text>
                    </View>
                </View>
